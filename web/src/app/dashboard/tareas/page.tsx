        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-3">
                ...
                <select
                    ...
                    className="bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/40"
                >
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-4">
                                        <div className={`p-2 rounded-lg ${statusConfig[ticket.status]?.bg || 'bg-gray-500/20'}`}>
